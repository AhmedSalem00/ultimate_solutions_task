class GetDeliveryBills {
  ...
  GetDeliveryBills({this.data, this.result});

  GetDeliveryBills.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['DeliveryBills'] != null) {
      ...
      json['DeliveryBills'].forEach((v) {
        deliveryBills!.add( DeliveryBills.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (deliveryBills != null) {
      data['DeliveryBills'] =
          deliveryBills!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
